...
// Module: HeytingLean.ClosingTheLoop.MR.PaperMapping
...
LEAN_EXPORT lean_object* initialize_HeytingLean_ClosingTheLoop_MR_PaperMapping(uint8_t builtin, lean_object* w) {
lean_object * res;
