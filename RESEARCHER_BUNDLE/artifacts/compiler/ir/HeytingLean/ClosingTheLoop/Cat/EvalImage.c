...
// Module: HeytingLean.ClosingTheLoop.Cat.EvalImage
// Imports: Init Mathlib.CategoryTheory.Limits.Shapes.Images HeytingLean.ClosingTheLoop.Cat.Selector
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_HeytingLean_ClosingTheLoop_Cat_EvalImage(uint8_t builtin, lean_object* w) {
lean_object * res;
