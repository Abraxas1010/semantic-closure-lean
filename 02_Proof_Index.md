...
6. **Meet-preserving section–retraction induces a nucleus**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Semantics/NucleusBridge.lean`
...
7. **Future-kernel operator is idempotent (closure law)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Semantics/PreorderTime.lean`
...
8b. **General time category kernel/nucleus (beyond preorders)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Semantics/FunctorialTime.lean`
...
9. **λ-calculus β-law (functional computation seed)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Semantics/LambdaIRBridge.lean`
...
10. **Process calculus kernel is exact on well-typed processes (concurrent computation seed)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Semantics/ProcessBridge.lean`
...
11. **(M,R) closure loop as a one-step stabilizing dynamics (Mealy/coalgebra hook)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Semantics/Mealy.lean`
...
12. **Relational realizability (invariants transport along simulations)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Semantics/RelationalRealizability.lean`
...
- File: `lean/HeytingLean/ClosingTheLoop/Cat/YonedaViewNat.lean`
...
1. **Inverse evaluation on the image (no overclaim from mono)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Cat/EvalImage.lean`
...
2. **No “concreteness assumption” needed for reflection (Yoneda route)**
   ...
   - File: `lean/HeytingLean/ClosingTheLoop/Cat/Concreteness.lean`
...
- File: `lean/HeytingLean/ClosingTheLoop/Tests/ClosureIdempotent.lean`
